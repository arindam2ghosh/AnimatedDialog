 ...
 */
public class BottomSheetAnimatedDialog extends AbstractDialog {

    private AppCompatActivity mActivity;

    protected BottomSheetAnimatedDialog(@NonNull final AppCompatActivity mActivity,
    ...
    /**
     * Builder for {@link BottomSheetAnimatedDialog}.
     */
    public static class Builder {
        ...
        /**
         * Build the {@link BottomSheetAnimatedDialog}.
         */
        @NonNull
        public BottomSheetAnimatedDialog build() {
            return new BottomSheetAnimatedDialog(activity, title, message, isCancelable, positiveButton, negativeButton, animationResId, animationFile);
        }
    }
